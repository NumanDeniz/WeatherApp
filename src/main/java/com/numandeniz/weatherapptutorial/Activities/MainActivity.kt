package com.numandeniz.weatherapptutorial.Activities
...
import com.numandeniz.weatherapptutorial.R
import com.numandeniz.weatherapptutorial.databinding.ActivityMainBinding
import com.numandeniz.weatherapptutorial.Models.WeatherModel
import com.numandeniz.weatherapptutorial.Utilites.ApiUtilities
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getCityWeather(city: String) {
        ...
        ApiUtilities.getApiInterface()?.getCityWeatherData(city,apiKey,"tr")
            ...
            override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
                if (response.isSuccessful){
                    ...
                    Toast.makeText(this@MainActivity, "Şehir Bulunamadı",
...
//    }
    ...
    private fun fetchCurrentLocationWeather(latitude: String, longitude: String) {
        ...
        ApiUtilities.getApiInterface()?.getCurrentWeatherData(latitude,longitude,apiKey,"tr")
            ?.enqueue(object :Callback<WeatherModel>{
            @RequiresApi(Build.VERSION_CODES.O)
            override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
